                ...
                <tbody>
                  @if(isset($cuentasCobrar))
                    @foreach($cuentasCobrar as $cpc)
                      ...
                      <tr>
                        <td>{{ $cpc->nombre }}</td>
                        <td>{{ $cpc->identificacion }}</td>
                        <td>{{ $cpc->fk_rubro }}</td>
                        <td>{{ $cpc->monto }}</td>
                          <td>{{ $cpc->moneda }}</td>
                        <td>
                         <a class="btn btn-primary btn-md" href="{{ url('/modificarCP') }}/{{$cpc->id}}"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Modificar</a>
