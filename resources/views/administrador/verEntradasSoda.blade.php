        ...
        <div class="box-body">
            <div class="form-group">
                <label for="nombre">Nombre Grupo</label>
                 <input type="text" step="any" class="form-control" name="grupo" value="{{$entradasSoda->AdministradorSoda->nombreGrupo}}" placeholder="Monto" disabled="true" >
                @if($errors->has('grupo'))
              ...
              <div class="form-group">
                ...
                <textarea type="text" class="form-control" name="descripcion"  placeholder="Descripcion.." style="max-height: 300px;min-height: 200px;" disabled="true">{{$entradasSoda->descripcion}}</textarea>
              ...
              <div class="form-group">
               ...
               <input type="number" step="any" class="form-control" name="monto" value="{{$entradasSoda->monto}}" placeholder="Monto" disabled="true">
               @if($errors->has('monto'))
